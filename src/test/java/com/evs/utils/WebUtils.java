...
public class WebUtils {
	...
	public void createExtentReport() {
		...
		ExtentSparkReporter extSpark = new ExtentSparkReporter(
				System.getProperty("user.dir") + "/Reports/" + "VtigerReports.html");
	...
	public void ckeckedAllCheckBoxes(List<WebElement> listCheckedBoxes) {
		...
		for (int i = 0; i < listCheckedBoxes.size(); i++) {
			...
			extTest.log(Status.INFO, "Successfully checked all check Boxes  Which is : - ");
		}
	}
	...
	public void unckeckedAllCheckBoxes(List<WebElement> listCheckedBoxes) {
		for (int i = 0; i < listCheckedBoxes.size(); i++) {
			...
			extTest.log(Status.INFO, "Successfully unchecked all check Boxes  Which is : ");
		}
	...
	public void verifyString(String actual, String expected) {
		if (actual.equals(expected)) {
			...
			extTest.log(Status.FAIL,
					"Actual value [ " + actual + "] And Expected value nat  match [" + expected + "  ]");
		}
	}
...
break;
			...
			extTest.log(Status.INFO, "Successfully found unique Name " + dataForVrfy);
				...
				extTest.log(Status.INFO, " not find unique Name " + dataForVrfy);	
			}
...
//			return columnNamelist;
	...
	public void getRowDataListByRowID(String tablelocator, String tablename, String uniqueData,
